...
function App() {
    ...
    return (
        <>
            ...
            <Routes>
                <Route path="/login"    element={ auth===false ?<LoginPage authenticateCB={setAuth}/>    :<Navigate to="/" />}/>
                <Route path="/register" element={ auth===false ?<RegisterPage authenticateCB={setAuth}/> :<Navigate to="/" />}/>
