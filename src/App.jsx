...
function App() {
    const {auth} = useContext(SubjectContext);

    return (
        <>
            <Routes>
                <Route path="/"         element={ auth===false ?<Navigate to="/login" />    :<Navigate to="/notification" />}/>
                <Route path="/login"    element={ auth===false ?<LoginPage/>                :<Navigate to="/notification" />}/>
                <Route path="/register" element={ auth===false ?<RegisterPage/>             :<Navigate to="/notification" />}/>
